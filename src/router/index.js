  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'register-supermarket',
          path: 'register-supermarket',
          component: () => import('../components/auth/SupermarketRegistration/SupermarketRegistration')
        },
        {
          name: 'supermarket-login',
          path: 'supermarket-login',
          component: () => import('../components/auth/SupermarketLogin/SupermarketLogin')
        },
        {
          path: '',
          redirect: { name: 'login' }
